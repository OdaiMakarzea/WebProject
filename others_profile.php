  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background:linear-gradient(to right, #8b7cef, #fdcbd5)">
    ...
    <ul class="navbar-nav mr-auto">
        <li class="nav-item dropdown">
          ...
          $query = "SELECT fname, lname,username FROM users WHERE username IN (SELECT sender_username FROM friend_request WHERE receiver_username='$thisuser')";
        ...
        <div class="d-flex flex-row border rounded" style="margin-top: 20px" >
          ...
          <div class="pl-3 pt-2 pr-2 pb-2 w-75 border-left">
            <?php
              echo "<h4 class='text-info'>".$row['fname']." ".$row['lname']."</h4>";
            ?>
